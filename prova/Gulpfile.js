...
gulp.task('include', function() {
		gulp.src(['src/home.html', 'src/sexual-strength.html', 'src/decline.html', 'src/strength-score.html', 'src/provarin.html', 'src/faq.html', 'src/healthcare.html', 'src/starter-kit-a.html'])
    .pipe(fileinclude({
        prefix: '@@',
        basepath: '@file'
    }))
...
// Default task
gulp.task('default', ['include', 'styles', 'server', 'watch']);