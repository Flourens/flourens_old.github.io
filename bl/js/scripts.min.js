...
$(document).ready(function(){function e(){var e=window.matchMedia("(max-width: 1200px)"),a=$(".hamburger"),o=$(".main-menu"),s=$(".main-menu__a");o.removeClass("main-menu--hiden main-menu--mobile"),a.addClass("hamburger--off"),s.removeClass("main-menu__a--mobile"),e.matches?(o.addClass("main-menu--hiden main-menu--mobile"),a.removeClass("hamburger--off"),s.addClass("main-menu__a--mobile")):(o.removeClass("main-menu--hiden main-menu--mobile"),a.addClass("hamburger--off"),s.removeClass("main-menu__a--mobile"))}$(".gallery-carousel").owlCarousel({loop:!0,smartSpeed:700,items:3,nav:!1,dots:!1,autoplay:!0,responsiveClass:!0,responsive:{0:{items:1},480:{items:2},768:{items:3},992:{items:3}}}),$(".gallery-venobox").venobox({overlayColor:"rgba(0, 0, 0, 0.3)",closeBackground:"rgba(0, 0, 0, 0)",arrowsColor:"rgba(255, 255, 255, 0.5)",spinner:"cube-grid"}),$(".review-carousel").owlCarousel({loop:!0,smartSpeed:700,items:1,nav:!1,dots:!0,autoplay:!0,margin:50,autoHeight:!0}),$(".featured-carousel").owlCarousel({loop:!1,smartSpeed:700,items:3,nav:!1,dots:!0,autoplay:!0,responsiveClass:!0,responsive:{0:{items:1},480:{items:2},768:{items:3},992:{items:3}}});var a=$(window),o=$(".navigation");a.on("scroll",function(){a.scrollTop()>150?o.addClass("navigation--bg"):o.removeClass("navigation--bg")}),$(function(){$.scrollIt({upKey:38,downKey:40,easing:"linear",scrollTime:600,activeClass:"main-menu__a--active",onPageChange:null,topOffset:0})}),$(window).on("resize",e),$(document).ready(e)});