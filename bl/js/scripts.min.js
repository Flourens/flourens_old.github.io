...
$(document).ready(function(){function e(){var e=window.matchMedia("(max-width: 1200px)"),a=$(".hamburger"),s=$(".main-menu"),n=$(".main-menu__a");s.removeClass("main-menu--hiden main-menu--mobile"),a.addClass("hamburger--off"),n.removeClass("main-menu__a--mobile"),e.matches?(s.addClass("main-menu--hiden main-menu--mobile"),a.removeClass("hamburger--off"),n.addClass("main-menu__a--mobile")):(s.removeClass("main-menu--hiden main-menu--mobile"),a.addClass("hamburger--off"),n.removeClass("main-menu__a--mobile"))}$(".gallery-carousel").owlCarousel({loop:!0,smartSpeed:700,items:3,nav:!1,dots:!1,autoplay:!0,responsiveClass:!0,responsive:{0:{items:1},480:{items:2},768:{items:3},992:{items:3}}}),$(".gallery-venobox").venobox({overlayColor:"rgba(0, 0, 0, 0.3)",closeBackground:"rgba(0, 0, 0, 0)",arrowsColor:"rgba(255, 255, 255, 0.5)",spinner:"cube-grid"}),$(".review-carousel").owlCarousel({loop:!0,smartSpeed:700,items:1,nav:!1,dots:!0,autoplay:!0,margin:50,autoHeight:!0}),$(".featured-carousel").owlCarousel({loop:!1,smartSpeed:700,items:3,nav:!1,dots:!0,autoplay:!0,responsiveClass:!0,responsive:{0:{items:1},480:{items:2},768:{items:3},992:{items:3}}}),$(function(){$.scrollIt({upKey:38,downKey:40,easing:"linear",scrollTime:600,activeClass:"main-menu__a--active",onPageChange:null,topOffset:0})}),$(window).on("resize",e),$(document).ready(e);var a=$(".hamburger"),s=$(".main-menu"),n=$(".main-menu__a");a.on("click",function(e){a.toggleClass("is-active"),s.toggleClass("main-menu--hiden")}),n.on("click",function(e){n.hasClass("main-menu__a--mobile")&&(a.removeClass("is-active"),s.addClass("main-menu--hiden"))});var i=$(window),o=$(".navigation");i.on("scroll",function(){i.scrollTop()>150?o.addClass("navigation--bg"):(o.removeClass("navigation--bg"),a.hasClass("is-active")&&(a.removeClass("is-active"),s.addClass("main-menu--hiden")))})});