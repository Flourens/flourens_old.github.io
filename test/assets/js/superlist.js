$(document).ready(function () {
	...
	$(document).ready(function () {
		//Header Bar stay top when scroll
		$(window).scroll(function () {
			if ($(window).scrollTop() > $('.main-inner').offset().top)
				$('.header-search-bar').addClass('floating');
			else
				$('.header-search-bar').removeClass('floating');
		});
		$('ol.carousel-title-indicators  li').on("click", function () {
			$('ol.carousel-title-indicators li.active').removeClass("active");
