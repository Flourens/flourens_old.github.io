...
$(document).ready(function(){$(function(){$(".pres-carousel").owlCarousel({responsive:{0:{items:1,slideBy:1},480:{items:2,slideBy:2,margin:15},1200:{items:3,slideBy:3}},items:3,margin:30,loop:true,dots:true,nav:false,slideBy:3})});$(function(){$(".feedback-carousel").owlCarousel({items:1,margin:300,loop:true,dots:true,nav:false,autoHeight:false,smartSpeed:700,autoplay:true})});$(function(){$.scrollIt({upKey:38,downKey:40,easing:"linear",scrollTime:600,activeClass:"main-menu__a--active",onPageChange:null,topOffset:0})});var e=$(window);var i=$(".navigation");e.on("scroll",function(){if(e.scrollTop()>80){i.addClass("navigation--bg")}else{i.removeClass("navigation--bg")}});$(function(){$(".venobox").venobox({spinner:"wave"})});$(window).on("resize",a);$(document).ready(a);function a(){var e=window.matchMedia("(max-width: 1200px)");var i=$(".hamburger");var a=$(".main-menu");var n=$(".main-menu__a");a.removeClass("main-menu--hiden main-menu--mobile");i.addClass("hamburger--off");n.removeClass("main-menu__a--mobile");if(e.matches){a.addClass("main-menu--hiden main-menu--mobile");i.removeClass("hamburger--off");n.addClass("main-menu__a--mobile")}else{a.removeClass("main-menu--hiden main-menu--mobile");i.addClass("hamburger--off");n.removeClass("main-menu__a--mobile")}}var n=$(".hamburger");var o=$(".main-menu");var t=$(".main-menu__a");n.on("click",function(e){n.toggleClass("is-active");o.toggleClass("main-menu--hiden")});t.on("click",function(e){if(t.hasClass("main-menu__a--mobile")){n.removeClass("is-active");o.addClass("main-menu--hiden")}});$(".form-submit").submit(function(){var e=$(this);$.ajax({data:e.serialize()}).done(function(){$("#answer-submit").modal({fadeDuration:100})});return false});$(".form-update").submit(function(){var e=$(this);$.ajax({data:e.serialize()}).done(function(){$("#answer-update").modal({fadeDuration:500})});return false})});function scaleVideoContainer(){var e=$(window).height();var i=parseInt(e)+"px";$(".hero-video").css("height",i)}function initBannerVideoSize(e){$(e).each(function(){$(this).data("height",$(this).height());$(this).data("width",$(this).width())});scaleBannerVideoSize(e)}function scaleBannerVideoSize(e){var i=$(window).width(),a=$(window).height(),n,o;console.log(a);$(e).each(function(){var e=$(this).data("height")/$(this).data("width"),t=a/i;if(e>t){n=i;o=n*e;$(this).css({top:-(o-a)/2+"px","margin-left":0})}else{o=a;n=o/e;$(this).css({"margin-top":0,"margin-left":-(n-i)/2+"px"})}$(this).width(n).height(o);$(".hero-video .hero-video__container").addClass("fadeIn animated")})}window.sr=ScrollReveal();sr.reveal(".section-headline, .avaliable__subtitle, .avaliable__stores",{origin:"top",duration:1500,opacity:0,scale:1});sr.reveal(".video, .middle-phone, .intro",{origin:"bottom",duration:800,opacity:1,scale:1,viewFactor:.2,distance:"50px",easing:"linear"});sr.reveal(".features__unit .fa, .flaticon-share",{origin:"top",duration:1e3,opacity:0,scale:1},50);sr.reveal(".plan--sr-animation-left, .contact-us",{origin:"left",duration:1e3,opacity:0,scale:1,mobile:true,delay:400,viewFactor:.2});sr.reveal(".plan--sr-animation-center",{origin:"top",duration:1500,opacity:0,scale:1,mobile:true,delay:400,viewFactor:.2});sr.reveal(".plan--sr-animation-right, .form-submit",{origin:"right",duration:1e3,opacity:0,scale:1,mobile:true,delay:400,viewFactor:.2});$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow");scaleVideoContainer();initBannerVideoSize(".hero-video__container .poster img");initBannerVideoSize(".hero-video__container video")});$(window).on("resize",function(){scaleVideoContainer();scaleBannerVideoSize(".hero-video__container .poster img");scaleBannerVideoSize(".hero-video__container video")});